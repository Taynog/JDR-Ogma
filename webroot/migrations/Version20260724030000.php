...
final class Version20260724030000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO \"sort\" (id, effet, propriete, ecole, dc, magnitude, description, inkarnai) VALUES
            ...
            (11, 'Transmutation', NULL, 'Altération', '10+1X', 'Dice_nb 2d4', 'Le lanceur lance [Mag] et en fait le total, si le résultat dépasse la résistance magique de la cible, elle devient métallique ou minérale.', 'Ourgal'),
            ...
            (13, 'Affaiblissement [Caractéristique]', '[Force, Dextérité, Agilité, Vigueur, Intelligence, Volonté, Perception, Éloquence]', 'Altération', '4+3X', 'Formula 1+1X', 'La [Caractéristique] de la cible diminue de [Mag] crans pendant une minute.', 'Agones, Eftis, Orizo, Kynigi, Psema'),
            ...
            (15, 'Vulnérabilité [Élément]', 'Concentration, [Acide, Eau, Feu, Foudre, Glace, Lumière, Nécrotique, Poison]', 'Altération', '3+2X', 'Formula 1+1X', 'La cible subit le trait Vulnérabilité([Mag],[élément]).', 'Aïgida, Anathos, Horoï, Kuga, Nero, Safi'),
            (16, 'Guérison', NULL, 'Altération', '4', '-', 'La cible passe un test de Vigueur avec un DC équivalent au triple de ses blessures et un bonus équivalent au DR du lanceur. Sur une réussite, la cible guérie d''une blessure.', 'Agapi'),
            ...
            (18, 'Récupération', NULL, 'Altération', '2', '-', 'La cible passe un test de Vigueur pour les traumas Physiques ou de Volonté pour les traumas Mentaux avec un DC équivalent au triple de ses traumas. Sur une réussite, la cible guérie d''un trauma.', 'Agapi'),
        ...
        $this->addSql("INSERT INTO \"sort\" (id, effet, propriete, ecole, dc, magnitude, description, inkarnai) VALUES
            ...
            (30, 'Entrave', 'Concentration', 'Conjuration', '4+2X', 'AD -0', 'La cible est immobilisée. Pour se libérer, la cible peut effectuer chaque round un test de Force, de Vigueur ou de Volonté avec un DC équivalent au cercle du sort.', 'Pravoï'),
            ...
            (39, 'Invocation de Karnarim élémentaire', '[Acide, Eau, Feu, Foudre, Glace, Lumière, Métal, Nécrotique, Pierre, Poison, Sable, Terre]', 'Conjuration', '6', '-', 'Invoque un Karnarim de l''[élément] pendant une minute.', 'Aïgida, Anathos, Horoï, Kormo, Kuga, Nero, Ourgal, Safi'),
            (45, 'Invocation d''Arme', NULL, 'Conjuration', '6+2X', 'Dice_scale 1d4', 'Invoque une arme infligeant [Mag] dégâts magiques à l''endroit ciblé.', 'Agones'),
            (48, 'Projection psychique', 'Concentration', 'Conjuration', '10', '-', 'L''esprit de cible est envoyé dans un domaine de Karnaï.', 'Selon le domaine visité'),
            (51, 'Bannissement', NULL, 'Conjuration', '0', '-', 'La cible est renvoyé dans sa dimension d''Origine.', 'Pravoï'),
            (54, 'Pas de l''ombre', NULL, 'Conjuration', '6+2X', 'Distance 10 mètres', 'La cible doit se tenir dans une ombre. Elle se téléporte dans une autre ombre située à moins de [Mag] de sa position.', 'Eftis'),
            (57, 'Téléportation', NULL, 'Conjuration', '8', 'Distance 10 mètres', 'La cible se téléporte sur une distance de [Mag] ou moins dans un éclair de lumière.', 'Safi'),
            (60, 'Racines du monde', NULL, 'Conjuration', '6', 'Distance 10 mètres', 'La cible se téléporte via les racines d''un arbre sur une distance de [Mag] ou moins.', 'Kormo'),
        ...
        $this->addSql("INSERT INTO \"sort\" (id, effet, propriete, ecole, dc, magnitude, description, inkarnai) VALUES
            ...
            (91, 'Contrôle mental', 'Concentration', 'Domination', '6', '-', 'La cible passe sous le contrôle du lanceur.', 'Kynigi, Kormo, Psema'),
            (92, 'Réécriture mémorielle', NULL, 'Domination', '8', '-', 'La dernière minute de mémoire de la cible est modifiée par le lanceur.', 'Psema'),
            (93, 'Mot de pouvoir : Douleur', 'Concentration', 'Domination', '4+2X', 'Double 1 && AD -1', 'La cible voie sa vitesse diminuée de [Mag] et effectue toute action avec [Mag] désavantage(s).', 'Psema'),
            (94, 'Mot de pouvoir : Mort', NULL, 'Domination', '15', '-', 'La cible meurt instantanément.', 'Anathos'),
            (95, 'Télékinésie', 'Concentration', 'Domination', '2+2X', 'Formula 1+1X', 'La cible obtient le trait Télékinésiste([Mag]).', 'Agones'),
            (96, 'Peur', NULL, 'Domination', '5', '1 minute', 'La cible est Effrayé(lanceur).', 'Agapi, Psema'),
            (97, 'Calme', NULL, 'Domination', '5', '1 minute', 'La cible est fasciné.', 'Psema'),
            (98, 'Rage', NULL, 'Domination', '5', '1 minute', 'La cible considère tout le monde comme un adversaire.', 'Agones')");

        // Domination suite
        $this->addSql("INSERT INTO \"sort\" (id, effet, propriete, ecole, dc, magnitude, description, inkarnai) VALUES
            (99, 'Silence', NULL, 'Domination', '5', '1 minute', 'La cible est incapable de parler.', 'Psema'),
            (100, 'Apparence trompeuse', 'Concentration', 'Domination', '6', '-', 'La cible est perçue comme quelqu''un d''autre.', 'Psema')");
        ...
        $this->addSql("INSERT INTO \"sort\" (id, effet, propriete, ecole, dc, magnitude, description, inkarnai) VALUES
            ...
            (104, 'Vision véritable', 'Concentration', 'Mysticisme', '6', '-', 'La cible voit tout, même les entités invisibles, peut voir dans le noir le plus complet et même dans une obscurité magique.', 'Orizo'),
            (105, 'Destinée', NULL, 'Mysticisme', '6+2X', 'Dice_nb 2d6', 'Le lanceur peut ajouter/enlever le résultat d''un des dés lancés par ce sort pour modifier le résultat de n''importe quel test.', 'Tychi'),
            (106, 'Augure', NULL, 'Mysticisme', '5', '-', 'La cible est avertie de son futur proche. (fortune, péril, les deux ou rien).', 'Tychi'),
            (107, 'Prophétie', NULL, 'Mysticisme', '10', '-', 'La cible obtient une réponse fiable sur un évènement à venir dans les 7 jours.', 'Tychi'),
        ...
        $this->addSql("INSERT INTO \"sort\" (id, effet, propriete, ecole, dc, magnitude, description, inkarnai) VALUES
            ...
            (72, 'Bourrasque', 'Concentration', 'Conjuration', '2+2X', 'Double 10', 'Invoque du vent se déplaçant à [Mag] km/h à l''endroit ciblé.', 'Aïgida'),
            (75, 'Spores [type]', '[Paralysie, Sommeil, Fascination, Confusion,...]', 'Conjuration', '5', '-', 'Invoque des spores infligeant l''effet [type].', 'Kormo'),
            ...
            (87, 'Création illusoire', NULL, 'Conjuration', '3+2', 'Gabarit TP && Time une minute', 'Façonne une création intangible de la forme souhaitée avec sons et odeurs de gabarit [Mag] ou moins pendant [Mag] minute.', 'Psema')");
