    ...
    <ul class="sidenav ">
        ...
        <li><span class="partie" onclick="hideContent(this)">Jeu de Rôle</span>
            <ul>
                ...
                <li><span class="dossier" onclick="hideContent(this)">Tableaux</span>
                    <ul class="hidden">
                        <li><span class="little"><a href="/Data/Rules/Tableaux.php#gabarit_creatures">Gabarit des créatures</a></span></li>
                    </ul>
                </li>
