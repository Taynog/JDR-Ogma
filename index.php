...
?>
    ...
    <ul class="changelog">
        ...
        <ul>
            ...
            <li>Sorts revus pour simplifier les effets et les rituels</li>
            <li>Combat simplifié en supprimant des parties inutilement compliquées</li>
        </ul>
        </li>
            ...
            <ul class="space_list">
                ...
                <li><strong>Version 2.4.1 15/10/2021</strong>
                    <ul>
                        ...
                        <li>Changements au niveau de la <a href="Data/Rules/Gabarit.php#gabarit_creatures">taille/gabarit</a> des créatures.</li>
                ...
                <li><strong>Version 2.3 28/07/2021</strong>
                    <ul>
                        ...
                        <li>Combat Rapide : Mise à jour du système de combat pour le rendre plus mortel, limiter la perte de temps à chaque tour de jeu et le nombre de rounds.</li>
                ...
                <li><strong>Version 2.2.1 11/04/2021</strong>
                    <ul>
                        ...
                        <li>Corrections et changement sur les <a href="Data/Rules/Personnage.php#table_carac_origine">bonus aux caractéristiques d'origine</a>.</li>
                    </ul>
                </li>
