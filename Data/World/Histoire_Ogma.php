...
?> 
    ...
    <h1 id="origine_monde" onclick="hideContent(this)">Origines du Monde</h1>
    <div>
    ...
    <h1 id="grande_revolte" onclick="hideContent(this)">La Grande Révolte</h1>
    <div>
    ...
    <h1 id="inkarnai" onclick="hideContent(this)">Les Inkarnaïs</h1>
    <div>
    ...
    <h1 id="economie" onclick="hideContent(this)">Économie mondiale</h1>
    <div>
    ...
    <h1 id="materiaux" onclick="hideContent(this)">Matériaux rares</h1>
    <div>
        <ul class="space_list">
    ...
    <h1 id="langages" onclick="hideContent(this)">Langages courants</h1>
    <div>
        <ul>
    ...
    <h1 id="sentinelles" onclick="hideContent(this)">Les Sentinelles</h1>
    <div>
