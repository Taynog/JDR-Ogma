    ...
    <div>
        ...
        <div>
            ...
            <ul style="list-style-type: upper-alpha">
                ...
                <li><b>Esquive :</b> Le défenseur passe une épreuve de Style de Combat(Agilité) et y ajoute son palier de maîtrise d'Acrobaties (+1 si Novice,..., +5 si Maître).</li>
            </ul>
            ...
            <ul style="list-style-type: upper-alpha">
                ...
                <li><b>Esquive :</b> l'assaillant inflige les dégâts de son arme au défenseur et y ajoute la différence entre son résultat et celui du défenseur. Si le défenseur ne subit aucune blessure, il peut se déplacer sur distance équivalente à la moitié de sa vitesse sans déclencher d'attaque d'opportunité.</li>
            </ul>
