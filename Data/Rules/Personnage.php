...
?> 
    ...
    <div>
        ...
        <div>
            ...
            <h3 id="resistance_physique" onclick="hideContent(this)">Résistance physique (RP)</h3>
            <div>
                <p>La résistance physique de votre personnage représente sa capacité à encaisser les coups. Elle est équivalente à la moitié de votre dé de Vigueur auquel s'ajoute la protection d'armure(PR) si vous portez une armure.</p>
                <p>Certaines origines comme les Kanta, les Sarpas-Crocodiles et les Steinns possèdent le trait <a href="Glossaire.php#robuste">Robuste</a> qui augmente leur resistance physique.</p>
            </div>

            <h3 id="resistance_magique" onclick="hideContent(this)">Resistance magique (RM)</h3>
            <div>
                <p>La résistance magique de votre personnage représente sa capacité à négliger les attaques magique. Elle est équivalente à la moitié de votre dé de Volonté auquel s'ajoute la protection d'armure magique (PR Magique) si vous portez une armure possédant la propriété Magique.</p>
            </div>

            <h3 id="blessures" onclick="hideContent(this)">Blessures</h3>
            <div>
                <p>Les blessures représentent l'intégrité physique de votre personnage, s'il n'en a aucune il est en parfait état, plus il subit de blessures plus il se rapproche de la mort.</p>
                <p>Chaque blessure que subit votre personnage impose un désavantage à tous ses tests. Votre personnage subit une blessure s'il subit des dégâts physiques/magiques supérieurs ou égaux à sa résistance physique/magique, chaque palier de 3 dégâts au-delà de la résistance de votre personnage cause une blessure supplémentaire.</p>
                <p>À chaque fois que votre personnage subit une blessure, il doit passer un test de Vigueur dans le cas d'une blessure physique, de Volonté dans le cas d'une blessure magique. Si le résultat de ce test est inférieur ou égal à 0, votre personage sombre dans l'<a href="Glossaire.php#inconscient">inconscience</a> et est <a href="Glossaire.php#mourant">mourant</a>. Pour de plus amples détails, se référer à la section <a href="Combat.php#blessures_mort">Blessures et mort</a>.</p>
                <p>Pour guérir d'une blessure, il est nécessaire d'effectuer un <a href="Survie.php#repos_long">repos long</a>, au terme de celui-ci, votre personnage peut effectuer un test de Vigueur avec un DC équivalent au triple des blessures de votre personnage. Si le test est réussi, le personnage guéri d'une blessure, sinon il obtient un avantage pour la prochaine réitération de ce test.</p>
                <p>Un médecin peut aider votre personnage à guérir plus rapidement et facilement en effectuant un test de Médecine(Dex) avec un DC équivalent au triple des blessures de votre personnage. Le médecin procure à son patient un bonus équivalent à son DR.</p>
            </div>

            <h3 id="traumas" onclick="hideContent(this)">Traumas</h3>
            <div>
