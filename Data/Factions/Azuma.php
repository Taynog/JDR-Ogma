...
?>
    ...
    <h2 onclick="hideContent(this)">L'archipel Quan Daõ</h2>
    <div>
    ...
    <h2 onclick="hideContent(this)">Un ensemble politique fort</h2>
    <div>
    ...
    <h2 onclick="hideContent(this)">Un monde civil strict</h2>
    <div>
        <ul>
            <li>
                <div>
